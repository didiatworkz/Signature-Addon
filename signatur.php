...
if($_GET['choose']) {
	...
	<tr>
		...
		<td class="td1" align="center"><textarea onclick="this.focus();this.select()" cols="40" rows="3"><img src="'.$code.'" alt="'.$_language->module['signatur'].'" /></textarea></td>
	</tr>
	<tr>
...
elseif($_GET['profile']) {
	...
	$signatur .= '
	<img src="'.$code.'" alt="'.$_language->module['signatur'].'" style="max-width:100%;" />';
	...
	if($anz) {
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="3" bgcolor="#DDDDDD">
		<tr>
			<td class="title"><b>'.$_language->module['signatur'].' '.$sig[sigID].'</b></td>
		</tr>
		<tr>
